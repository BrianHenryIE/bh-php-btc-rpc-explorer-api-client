...
readonly class VIn
{
     ...
     * @param string[] $txIinWitness Transaction input witness - SegWit witness data containing signatures and public keys, stored separately from legacy transaction data.
